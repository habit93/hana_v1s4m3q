...
%> 
  <TR>
    ...
    <TD class='td'>
      <A href="javascript:update(<%=codeno%>, '<%=vo.getSort() %>')"><IMG src='./images/update.png' title='수정'></A>
...
<DIV class='bottom'>
  ...
  <button type='button' onclick="location.href='../blogcategory/list.do'">카테고리 목록</button>
</DIV>
<!-- -------------------------------------------- -->
