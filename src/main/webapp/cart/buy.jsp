...
<DIV class='content'>
    <!-- 구매 폼 -->
    <FORM name='frm_buy' method="POST" action='./buy.do'>
      <input type='hidden' name='cartno' id='cartno' value='<%=cartVO.getCartno()%>'>
      <input type='hidden' name='name' id='name' value='<%=cartVO.getName()%>'>
      <input type='hidden' name='itemno' id='itemno' value='<%=cartVO.getItemno() %>'>
      <input type='hidden' name='price' id='price_hb' value='<%=cartVO.getPrice() %>'>
      <input type='hidden' name='mno' id='mno' value='${mno }'>
      <input type='hidden' name='cnt' id='cnt' value='<%=cartVO.getCnt()%>'>
      <ul>
      <li>
       <label>이름</label>
       <span><%=cartVO.getName()%></span>
      </li>
      <li>
        <label for='cnt'>수량</label>
        <span id='cnt'><%=cartVO.getCnt() %></span>
      </li>
      <li>
        <label>총 상품 가격</label>
        <span id='price_b'><%=cartVO.getPrice()%></span>
      </li>
      <li>
